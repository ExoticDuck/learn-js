...
alert(accumulator.value); // выведет сумму этих значений`}],l=[{id:"1",task:`// Сумма пользовательских чисел
// важность: 5
...
// Почините код, чтобы он работал как задумано.`},{id:"15",task:`
